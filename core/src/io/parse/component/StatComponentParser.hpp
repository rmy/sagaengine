...
#ifndef StatComponentParser_hpp
#define StatComponentParser_hpp
...
namespace se_core {
	class _SeCoreExport StatComponentParser : public ComponentParser {
	public:
		StatComponentParser();
	...
	extern _SeCoreExport const StatComponentParser parserStatComponent;
}
