...
#include "AudiereAreaComponentFactory.hpp"
...
namespace se_audiere {
	...
	AudiereAreaComponentFactory
	::AudiereAreaComponentFactory()
		: ComponentFactory(sct_AUDIERE) {
	}


	Component* AudiereAreaComponentFactory
	::create(Composite* owner) const {
		...
		AudiereAreaComponent::Ptr pAudiere(*owner);
		if(pAudiere == 0) {
			// Create new component
			pAudiere = new AudiereAreaComponent(owner, this);
		}
