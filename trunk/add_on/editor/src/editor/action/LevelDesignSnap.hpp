...
#ifndef LevelDesignSnap_hpp
#define LevelDesignSnap_hpp

#include "sim/action/Action.hpp"

namespace se_editor {

	class LevelDesignSnap : public se_core::Action {
	public:
		LevelDesignSnap() : se_core::Action("LevelDesignSnap") {}
	...
	extern _NavMeshLogicExport const LevelDesignSnap actionLevelDesignSnap;
}
