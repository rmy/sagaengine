...
#ifndef AcPasteLevel_hpp
#define AcPasteLevel_hpp
...
namespace se_editor {
	class _SeEditorExport AcPasteLevel : public se_core::Action {
	public:
		AcPasteLevel();
		virtual ~AcPasteLevel();
	...
	extern _SeEditorExport const AcPasteLevel actionPasteLevel;
}
