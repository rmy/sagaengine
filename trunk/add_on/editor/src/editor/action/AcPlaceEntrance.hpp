...
#ifndef AcPlaceEntrance_hpp
#define AcPlaceEntrance_hpp
...
namespace se_editor {
	class _SeEditorExport AcPlaceEntrance : public se_core::Action {
	public:
		AcPlaceEntrance();
		virtual ~AcPlaceEntrance();
		...
		const AcPlaceEntrance& param(int id, se_core::Parameter& out) const;
	...
	extern _SeEditorExport const AcPlaceEntrance actionPlaceEntrance;
