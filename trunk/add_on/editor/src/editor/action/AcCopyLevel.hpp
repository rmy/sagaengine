...
#ifndef AcCopyLevel_hpp
#define AcCopyLevel_hpp
...
namespace se_editor {
	class _SeEditorExport AcCopyLevel : public se_core::Action {
	public:
		AcCopyLevel();
		virtual ~AcCopyLevel();
	...
	extern _SeEditorExport const AcCopyLevel actionCopyLevel;
}
