...
#ifndef logic_RotateCamera_hpp
#define logic_RotateCamera_hpp
...
namespace logic {
	class _FlyLogicExport RotateCamera : public se_core::Action {
	public:
		RotateCamera() : se_core::Action("rotate_camera") {}
	...
	extern _FlyLogicExport const RotateCamera actionRotateCamera;
}
