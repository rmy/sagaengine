...
#ifndef SimpleCameraParserModule_hpp
#define SimpleCameraParserModule_hpp

#include "GamePre.H"

namespace game {

	class SimpleCameraParserModule : public se_core::ParserModule {
	public:
		SimpleCameraParserModule(se_core::Parser& parser);
