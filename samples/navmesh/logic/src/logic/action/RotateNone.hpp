...
#ifndef logic_RotateNone_hpp
#define logic_RotateNone_hpp

#include "sim/action/Action.hpp"

namespace logic {
	class _NavMeshLogicExport RotateNone : public se_core::Action {
	public:
		RotateNone() : se_core::Action("RotateNone") {}
	...
	extern _NavMeshLogicExport const RotateNone actionRotateNone;
}
