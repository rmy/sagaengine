#ifndef logic_physics_PhMissile_hpp
#define logic_physics_PhMissile_hpp

#include "LogicPre.hpp"

namespace logic {

	class _NavMeshLogicExport PhMissile : public se_core::Physics {
	public:
		PhMissile() : se_core::Physics("Missile") {}
