...
namespace se_pulseaudio {
	...
	::PulseaudioAreaComponent(Composite* owner, const se_core::ComponentFactory* factory) 
			: RootChildComponent(se_core::sct_PULSEAUDIO, owner, factory) {
	}
