...
#ifndef LevelDesignCleanRoom_hpp
#define LevelDesignCleanRoom_hpp

#include "sim/action/Action.hpp"

namespace se_editor {

	class LevelDesignCleanRoom : public se_core::Action {
	public:
		LevelDesignCleanRoom() : se_core::Action("LevelDesignCleanRoom") {}
	...
	extern _NavMeshLogicExport const LevelDesignCleanRoom actionLevelDesignCleanRoom;
}
