...
#ifndef ndl_area_WorldManager_hpp
#define ndl_area_WorldManager_hpp

#include "../gfx/canvas/Canvas.hpp"
#include "../schema/NCursSchema.hpp"
#include "client/event/ClientListener.hpp"
#include "sim/area/sim_area.hpp"
#include "sim/thing/sim_thing.hpp"

namespace se_ncurs {
	class WorldManager : public se_core::ClientListener {
	public:
		WorldManager();
		virtual ~WorldManager();

		void setWorldGeometry(se_core::Area& area);
